/// \file
/// \brief Internal header file that describes the basic_input_memory_stream
/// class template.
/// \author Lyberta
/// \copyright BSLv1.
...
class basic_input_memory_stream final :
	public PositionHelper<basic_input_memory_stream<Container>,
		typename Container::difference_type>
{
public:
	// Constructors
	constexpr basic_input_memory_stream() = default;
...
#include "basic_input_memory_stream.hpp"
